...
func (Error_ErrorType) EnumDescriptor() ([]byte, []int) {
	return file_spec_proto_rawDescGZIP(), []int{21, 0}
}
...
/// A proto object representing the result of Concept execution.
type ProtoConceptResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	/// Collection of steps in concept execution result.
	ProtoItem *ProtoItem `protobuf:"bytes,1,opt,name=protoItem,proto3" json:"protoItem,omitempty"`
	/// Holds the time taken for executing the whole suite.
	ExecutionTime int64 `protobuf:"varint,2,opt,name=executionTime,proto3" json:"executionTime,omitempty"`
	/// Holds the timestamp of event starting.
...
func (x *ProtoConceptResult) Reset() {
	*x = ProtoConceptResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProtoConceptResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoConceptResult) ProtoMessage() {}

func (x *ProtoConceptResult) ProtoReflect() protoreflect.Message {
	mi := &file_spec_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtoConceptResult.ProtoReflect.Descriptor instead.
func (*ProtoConceptResult) Descriptor() ([]byte, []int) {
	return file_spec_proto_rawDescGZIP(), []int{19}
}

func (x *ProtoConceptResult) GetProtoItem() *ProtoItem {
	if x != nil {
		return x.ProtoItem
	}
	return nil
...
func (x *ProtoConceptResult) GetExecutionTime() int64 {
	if x != nil {
		return x.ExecutionTime
	}
	return 0
...
func (x *ProtoConceptResult) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
var file_spec_proto_rawDesc = []byte{
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x91, 0x01, 0x0a, 0x12, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x43, 0x6f, 0x6e, 0x63, 0x65, 0x70, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c,
	...
	0x07, 0x53, 0x4b, 0x49, 0x50, 0x50, 0x45, 0x44, 0x10, 0x03, 0x42, 0x60, 0x0a, 0x16, 0x63, 0x6f,
	0x6d, 0x2e, 0x74, 0x68, 0x6f, 0x75, 0x67, 0x68, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x2e, 0x67,
	0x61, 0x75, 0x67, 0x65, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x64, 0x6d, 0x69, 0x74, 0x72, 0x79, 0x2d, 0x73, 0x61, 0x6c, 0x69, 0x6e, 0x2f, 0x67, 0x61,
...
var file_spec_proto_goTypes = []interface{}{
	...
	(*ProtoConceptResult)(nil),          // 25: gauge.messages.ProtoConceptResult
	(*ProtoStepResult)(nil),             // 26: gauge.messages.ProtoStepResult
	(*Error)(nil),                       // 27: gauge.messages.Error
...
var file_spec_proto_depIdxs = []int32{
	...
	27, // 40: gauge.messages.ProtoSpecResult.errors:type_name -> gauge.messages.Error
	7,  // 41: gauge.messages.ProtoScenarioResult.protoItem:type_name -> gauge.messages.ProtoItem
	7,  // 42: gauge.messages.ProtoConceptResult.protoItem:type_name -> gauge.messages.ProtoItem
	7,  // 43: gauge.messages.ProtoStepResult.protoItem:type_name -> gauge.messages.ProtoItem
	5,  // 44: gauge.messages.Error.type:type_name -> gauge.messages.Error.ErrorType
...
func file_spec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_spec_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoConceptResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
